...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        {
            "HealthProviders": [
                <xsl:for-each select="ManagementSystem/Users/HealthProviders">
                    {
                        ...
                        "TypeOfHealthProviders": {
                            <xsl:choose>
                                <xsl:when test="TypeOfHealthProviders/ServiceCompanies">
                                    "ServiceCompanies": {
                                        "Name": "<xsl:value-of select='TypeOfHealthProviders/ServiceCompanies/Name'/>",
                                        "Email": "<xsl:value-of select='TypeOfHealthProviders/ServiceCompanies/Email'/>",
                                        "address": "<xsl:value-of select='TypeOfHealthProviders/ServiceCompanies/address'/>"
                                    }
                                </xsl:when>
            ...
            "Services": [
                <xsl:for-each select="ManagementSystem/Services/*">
                    {
